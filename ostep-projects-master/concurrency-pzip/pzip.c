...
int main(int argc, char *argv[]) {
  ...
  Sem_close(&empty);
  Sem_close(&full);
  Sem_unlink(mutexString);
  Sem_unlink(emptyString);
  Sem_unlink(fullString);
